            ...
            <div class="product-thumb">
              <div class="text-center">
                ...
                <div style="margin-bottom:5px;">
                  <button type="button" rel="<?php echo $result['bundle_id']; ?>" class="btn btn-primary" id="bundle-cart"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $button_addtocart; ?></span></button>
                </div>
              </div>
            </div>
          </div>
