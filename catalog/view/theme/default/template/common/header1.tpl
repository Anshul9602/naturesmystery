            ...
            <div class="col-sm-4">
              <span id="donate-msg">
                <a style="color:#fff; text-transform: initial" href="mailto:Info@mellow.co.in">
                  <li class="fa fa-envelope"></li> &nbsp;info@nature.co.in
        ...
        <div class="container">
          <div class="row">
            <div class="col-6">
              <span id="donate-msg">
                <a style="color:#fff; text-transform: initial" href="mailto:Info@mellow.co.in">
                  <li class="fa fa-envelope"></li> &nbsp;Info@mellow.co.in
                </a>
              </span>
        ...
        <div class="row align-items-center">
          <div class="col-12">
            <div class="mobile-main-header">
              <div class="mobile-logo" style="max-width:45%">
                <a href="<?php echo $home; ?>">
