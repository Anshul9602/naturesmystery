    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="col-sm-6 text-right" style="margin-top:25px;">
          <span style="background-color:#5bb75b; color:#fff; padding:9px;"><b>Bundle Discount = <?php echo $groupdiscount; ?></b></span>
        </div>
		<?php } ?>
      </div>
      <form action="" method="post" enctype="multipart/form-data" class="tmdbundle">
        <div class="table-responsive">
          <table class="table table-bordered">
            <thead>
              <tr>
                <td class="text-center bgc1"><?php echo $column_image; ?></td>
                <td class="text-left bgc1"><?php echo $column_name; ?></td>
                <td class="text-left bgc1"><?php echo $column_model; ?></td>
                <td class="text-left bgc1"><?php echo $column_quantity; ?></td>
                <td class="text-left bgc1"><?php echo $column_price; ?></td>
                <td class="text-center bgc1"><?php echo $column_option; ?></td>
              </tr>
            </thead>
            <tbody >
