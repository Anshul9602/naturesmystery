...
<div style=" margin-bottom:40px; padding-top:30px; min-height:60vh" class="container">
  <div class="row">
    <div class="col-sm-12">

      <div class="row">
        <div style="background-color:#fff; padding-top:5px" class="col-sm-12">
        ...
        <div style="margin-top:30px; padding-right:20px" class="col-sm-4">
          <div class="col-sm-12" style="background-color:#f1f1f1">
            ...
            <p style="padding:20px; font-size:14px">
              ...
              EMAIL: naturemysterry@gmail.com</p>
            <hr style="margin:0" />
            <p style="padding:20px; font-size:14px">
          ...
          success: function(html) {
            ...
            $.ajax({
              ...
              success: function(json) {
                ...
                if($("#collapse-payment-method input[type=\'radio\']:checked").val()=="razorpay"){
                  $.ajax({
                      url: 'index.php?route=extension/total/coupon/coupon',
                      type: 'post',
                      data: 'coupon=prepaid10',
                      dataType: 'json',
                      beforeSend: function() {
