              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <button type="button" id="button-seourls" rel="<?php echo $language['language_id']; ?>" class="btn btn-info col-sm-12"><i class="fa fa-bolt"></i> <b>Generate Seo</b></button>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="hidden" name="bundle_parent_id" value="<?php echo $bundle_parent_id; ?>" />
                  <?php if ($error_parent) { ?>
...
$('input[name=\'path\']').autocomplete({
	...
	'select': function(item) {
		...
		$('input[name=\'bundle_parent_id\']').val(item['value']);
	}
});
//--></script> 
...
$(document).on('click','#button-seourls',function() {
  rel=$(this).attr('rel');
  name=$('#input-name'+rel).val();
  $.ajax({
    url: 'index.php?route=bundle/category/SeoText&token=<?php echo $token; ?>&name='+name,
    type: 'post',
    data: '',
    dataType: 'json',
    beforeSend: function() {
    ...
    success: function(json) {
      if (json['success']) {
        $('input[name=\'keyword\']').val(json['seoname']);
        $('input[name=\'category_description['+rel+'][meta_title]\']').val(json['name']);
        $('textarea[name=\'category_description['+rel+'][meta_description]\']').val(json['name']);
        $('textarea[name=\'category_description['+rel+'][meta_keyword]\']').val(json['name']);
      }
    },
  });
});
